            ...
            <div class="member-card slide-in-right">
                ...
                <div class="member-activity">
                    ...
                    <div class="activity-list">
                        <p>Вёрстка макета, его реализация на страницах сайта;</p>
                        <p>Работа с валидацией, файловой системой и базой данных;</p>
                        <p>Управление и настройка инфраструктуры сайта для его работы в целом;</p>
                        <p>Принятие решений по реализации тех или иных идей на сайте.</p>
                    </div>
                </div>
                <div class="member-quote">
                    <h3>Личная цитата о проекте:</h3>
                    <p>«Я бэкэнд разработчик и я в рот ебал заниматься фронтэндом. Дизайнер кстати ахуел».</p>
                </div>
            </div>
        </article>
