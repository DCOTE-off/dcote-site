...
<template>
    ...
    <nav class="mobile-nav">
        <Link v-if="!user" :href="route('login')" class="mobile-nav__item">
        ...
        <Link :href="route('home')" class="mobile-nav__item">
            <svg class="mobile-nav__logo"><use href="#dcote-logo-small" /></svg>
        </Link>
