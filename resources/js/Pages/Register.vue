        ...
        <div class="auth__panel">
            <form id="registration-form" class="auth__form" novalidate @submit.prevent="submit">
                ...
                <div class="auth__field">
                    ...
                    <span v-if="form.errors.nickname" class="auth__error">{{ form.errors.nickname }}</span>
                </div>
                <div class="auth__field">
                ...
                <div class="auth__field">
                    ...
                    <span v-if="form.errors.password_confirmation" class="auth__error">{{
                        form.errors.password_confirmation
                    }}</span>
                </div>
                <p class="auth__check">
                    Регистрируясь, вы принимаете <Link :href="route('rules')">правила сайта</Link> и
                    <Link :href="route('privacy_policy')">политику конфиденциальности</Link>
                </p>
